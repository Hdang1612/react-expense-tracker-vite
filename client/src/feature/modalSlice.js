...
export const setTransactionData = createAsyncThunk('modal/setTransactionData', async (data) => {
  try {
    if (data) {
...
export const { toggleModal, setModalTitle, resetTransactionData } = modalSlice.actions
